...
three(){
	...
	if [ "$UP_TO_DATE" -ne 1 ]; then
			...
			update_ark
			forever start -l ${arkdir}/logs/process.log -o ${arkdir}/logs/process-output.log -e ${arkdir}/logs/process-errors.log app.js --genesis genesisBlock.mainnet.json --config config.mainnet.json >&- 2>&-
